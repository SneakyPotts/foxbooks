...
export const verifyEmail = createAsyncThunk('auth/verifyEmail', async (data) => {
  const response = await AuthService.verifyEmail(data);
  return response.data;
});

export const signInWithSocial = createAsyncThunk('auth/signInWithSocial', async (data, thunkApi) => {
