...
const AudioPlayer = () => {
  ...
  const handlePrev = () => {
    const currentChapterIndex = playerData?.chapters?.findIndex((i) => i?.id === currentChapter);
    const prevChapterIndex = currentChapterIndex === -1 || currentChapterIndex === 0 ? 0 : currentChapterIndex - 1;
      ...
      <div className={styles.wrapperColumn}>
        <div className={styles.preview}>
          ...
          <div className={styles.previewWrapper}>
            ...
            <span className={styles.previewText}>{playerData?.chapters?.find((i) => i?.id === currentChapter)?.title || playerData?.chapters?.[0]?.title}</span>
          </div>
        </div>
      </div>
      <div className={styles.wrapperColumn}>
