    ...
    const dataSEO =
      params.books_type === 'books'
        ? {
            ...
            description:
              'Слушать самые лучшие аудиокниги онлайн бесплатно и без регистрации на FoxBooks: популярные новинки, профессиональные чтецы, большая библиотека и доступ с любого гаджета!',
        ...
        : {
            ...
            description:
              'Читать онлайн книги всех жанров на онлайн-библиотеке FoxBooks: фэнтези, фантастика, современная литература, любовные романы, отечественная и зарубежная литература и много другого! Сайт доступен на всех гаджетах.',
